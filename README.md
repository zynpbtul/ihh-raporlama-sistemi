...
- **Canlı Demo URL**: _(Hazır olduğunda buraya eklenecektir)_  
- **Yedek Demo Videosu**: _(İnternet kesintisi riskine karşı hazırlanan ekran kaydı)_  
- **Teslim Edilen Kaynak Kod (Drive Linki)**: _(Mentörle paylaşılan ortak drive klasörü)_  
